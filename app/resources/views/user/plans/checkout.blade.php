                ...
                <tr>
                  ...
                  <td class="text-center"><i class="nc-icon nc-check-2 text-success"></i></td>
                                ...
                                <tr>
                                    ...
                                    @foreach ($plans as $item)
                                    <td class="text-center">{{toPersianMoney($item->price)}} تومان</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a target="_blank" href="#" class="btn btn-round btn-primary-bronz">خرید طرح
                                            برنز</a>
                                    </td>
                                    <td class="text-center">
                                        <a target="_blank" href="#" class="btn btn-round btn-primary-silver">خرید طرح
                                            نقره ای</a>
                                    </td>
                                    <td class="text-center">
                                        <a target="_blank" href="#" class="btn btn-round btn-primary-gold">خرید طرح
                                            طلایی</a>
                                    </td>
                                </tr>
                        ...
                        <div class="alert alert-warning alert-dismissible fade show text-right">
                            ...
                            <span><b> توجه - </b> قبل از انجام خرید قوانین سایت را مطالعه نمایید. <a target="_blank"
                                    href="#" class="btn btn-round btn-primary ">قوانین سایت</a></span>
                        </div>
