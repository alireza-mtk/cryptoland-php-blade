...
@section("main")
        <section class="promo">
			<div class="container">
				...
				<img src="{{ asset("assets/images/promo-bg.png")}}"   alt="" class="promo__img">
						...
						<div class="col">
							<div class="facts__line-list">
								<div class="facts__item">
										<img src="{{ asset("assets/images/bitcon-round.png")}}" class="facts__icon" alt="">
										<div class="facts__title">
											Bitcoin + RSK
										</div>
									</div>
									<div class="facts__item">
										<img src="{{ asset("assets/images/stellar-round.png")}}" class="facts__icon" alt="">
										<div class="facts__title">
											Stellar Lumens
										</div>
									</div>
									<div class="facts__item">
										<img src="{{ asset("assets/images/counterparty-round.png")}}" class="facts__icon" alt="">
										<div class="facts__title">
											Counterparty
										</div>
									</div>
									...
									<div class="facts__item">
										<img src="{{ asset("assets/images/eos-round.png")}}" class="facts__icon" alt="">
										<div class="facts__title">
											EOS
										</div>
									</div>
