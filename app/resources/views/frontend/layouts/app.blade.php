...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset("assets/user/assets/js/summernote/summernote-bs4.min.css")}}">
...
<body class="hold-transition sidebar-mini layout-fixed d-rtl">
  ...
  <script src="{{asset("assets/user/assets/js/summernote/summernote-bs4.min.js")}}"></script>
